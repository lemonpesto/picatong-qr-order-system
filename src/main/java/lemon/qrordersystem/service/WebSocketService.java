...
public class WebSocketService {
    ...
    // user
    private String topicTableCart(Long tableId) { return "/topic/tables/" + tableId + "/cart"; }
    private String topicTableNav(Long tableId)     { return "/topic/tables/" + tableId + "/nav"; }
    private String topicTablePayment(Long tableId) { return "/topic/tables/" + tableId + "/payment"; }

    // order progress (부분 갱신)
    private String topicOrderProgress(Long orderItemId){ return "/topic/orders/" + orderItemId + "/progress"; }
    ...
    private void sendAfterCommit(Runnable sendAction) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            @Override public void afterCommit() { sendAction.run(); }
        });
    }
